...
\definecolor{softblue}{RGB}{238,246,252}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small 实验六\quad 波形发生器实验}
...
\lstdefinelanguage{A51}{
  morekeywords={ORG,LJMP,JMP,SJMP,START,MAIN,LOOP,MOV,SETB,ACALL,DJNZ,PUSH,POP,RET,RETI,END,DELAY,DB,CPL,INC,DEC,JNZ,CJNE,JNB,ANL,ADD,CLR,SUBB,MOVC,P0,P1,P2,SP,DPTR,ACC,B,R0,R5,R6,A},
  sensitive=false,
  morecomment=[l]{;}
}
...
\newcommand{\FinishDate}{2026年6月1日}
...
\begin{titlepage}
  ...
  \vspace{1.1cm}
  {\zihao{-1}\bfseries 实验六\quad 波形发生器实验\par}

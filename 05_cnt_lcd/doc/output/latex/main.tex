...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small 实验五\quad 脉冲计数实验}
...
\lstdefinelanguage{A51}{
  morekeywords={ORG,LJMP,JMP,SJMP,AJMP,MAIN,MOV,SETB,CLR,NOP,INC,DEC,RL,DJNZ,JNB,JZ,CJNE,MOVC,DB,END,EQU,PUSH,POP,RET,RETI,LCALL,P0,P1,P2,P3,SP,DPTR,ACC,PSW,TMOD,TH1,TL1,IE,IP,IT0,IT1,TR1,R0,R5,R6,R7,A},
  sensitive=false,
  morecomment=[l]{;}
}
...
\newcommand{\FinishDate}{2026年6月22日}
...
\begin{titlepage}
  ...
  \vspace{1.1cm}
  {\zihao{-1}\bfseries 实验五\quad 脉冲计数实验报告\par}
